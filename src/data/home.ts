...
export const content =
  'Dalam implementasi nya kita dapat bekerja secara fleksibel dengan penggunaan single standalone system artinya secara keseluruhan di handle dalam satu perangkat mesin kasir, atau via pembagian divisi seperti menggunakan waiters tablet order untuk mencatat pesanan pelanggan, kitchen print untuk melakukan print out pesanan pelanggan, kitchen display untuk menampilkan pesanan pelanggan pada layar dapur, dan berbagai kebutuhan lain nya.';
export const text =
  'Dan saat nya kini menggunakan software resto app kami untuk menunjang dan solusi terbaik untuk pembukuan plus mempercepat transaksi restoran cafe rumah makan .';
export const btn = 'Mulai Sekarang →';
export const link = '/pos';
