...
export const SITE_YOUTUBE =
  'https://www.youtube.com/c/bakoelraksupermarketMesinKasir';
export const SITE_VIDEO = 'https://www.youtube.com/watch?v=NLxDbnyQ4r4';
export const SITE_POS = 'Fitur Program Software Resto Applikasi';
export const SITE_POSDESC =
  'Cek disini detail bagaimana program software restoran bekerja include video demo.';
